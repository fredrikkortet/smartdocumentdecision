...
use_stub = st.checkbox("Use Stub Backend (fast, local)", value=True)
    ...
    if not uploaded_file:
        ...
        try:
            ...
            try:
                ...
                if isinstance(result, dict) and result.get("key_insights"):
                    st.write(result.get("key_insights"))
                ...
                st.subheader("Reasoning / Full Response")
